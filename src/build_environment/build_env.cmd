...
set "BUILD_SANDBOX_DIR=C:\S1000"

:: Choose P or D here for a production or debug build respectively
set BTYPE=D

:: The full path to where you installed the Java SDK, the java binary should
:: be at %JAVA_HOME%\bin\java.exe. If you used the standard installer then you
:: shouldn't need to change this
set "JAVA_HOME=C:\Program Files\IBM\Java80"

:: The full path to where you installed IBM MQ, if you installed MQ v9 at the
:: standard location you shouldn't need to change this.
set "MQ_HOME=C:\Program Files\IBM\MQ"

:: The full path to where you installed your Perl distribution. The perl executable
:: should be at %PERL_HOME$\bin\perl.exe. If you installed Strawberry perl with the
:: default options then you shouldn't need to change this
set "PERL_HOME=C:\Strawberry\perl"

::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
:: The rest is inferred based on the above settings
::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::

:: We currently only support running on Windows for AMD64 processors. We may
:: eventually want to run on Windows for ARM64 but for now we explicitly bail
:: out if we're not on an AMD64 processor.
...
for /F "tokens=1* delims==" %%A in (%BUILD_SANDBOX_DIR%\iib.version\version.properties) do (
    if "%%A"=="version_vrm" set "VERSION_VRM=%%B"
)
...
if not exist "%MSVC_VCVARSALL%" (
	@echo ERROR: Failed to find vcvarsall.bat - is Visual Studio installed into the default location?
	@echo vcvarsall.bat was expected to be found at %MSVC_VCVARSALL%
	exit /b 1
)
...
set "WMB_BUILD_TOOLS=%BUILD_SANDBOX_DIR%\WMB\src\build"
endlocal & set "PATH=%WMB_BUILD_TOOLS%;%ODE_PATH%;%ANT_BIN%;%JAVA_HOME%\bin;%PERL_BIN%;%BLD_TOOLS%;%PATH%"
